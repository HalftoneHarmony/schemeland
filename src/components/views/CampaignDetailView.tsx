...
import { ArrowLeft, Map, Calendar, Flag, Zap, Plus, Shield, Activity, Terminal } from 'lucide-react';
...
export function CampaignDetailView({ activeProject, selectedMonthIndex, onBack }: CampaignDetailViewProps) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 animate-slide-up pb-40">
